...
export const signUpValidation = z
    .object({
        ...
        password: z.string({ message: "require password" }).min(6, "password required at least 6 character")
    })
    .required();
...
export const signUpValidationFormSchema = z
    .object({
        ...
        email: z.string({ message: "Please enter an email address" }).email({ message: "Invalid email format" }),
        password: z
